...
def result():
    ...
    scaler_path=os.path.join('D:/rtsr/Stroke-Risk-Prediction-using-Machine-Learning','models/scaler.pkl')
    scaler=None
...
if __name__=="__main__":
    app.run(debug=True,port=7382)
#here just we have to initalize only port number